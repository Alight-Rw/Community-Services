    ...
    <div className="  min-h-screen  font-sans">
      ...
      <div className="flex justify-end items-center gap-4  bg-primary shadow-lg w-full h-20">
        ...
        <div className="relative p-2 bg-white rounded-xl shadow-sm border border-gray-100 cursor-pointer">
          <span className="absolute -top-1 -right-1  text-white h-auto w-auto bg-red-500  rounded-full text-[10px] font-bold rounded-full h-4 w-4 flex items-center justify-center border-2 border-white">
            22
          </span>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
