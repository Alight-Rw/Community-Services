      ...
      <div className='flex flex-1 overflow-hidden relative'>
        ...
        <main className='flex-1 pl-20 overflow-y-auto transition-all duration-300'>
          <div className='px-8 md:px-0 pt-20 md:space-y-1 '>
            <Paragraphy highlight='Completed Services' description='Quick summary of services that have been successfully delivered and finalized.' />
          </div>

          <div className='px-8 md:px-0 md:pr-12 py-10 w-[350px] md:w-full'>
            <DashboardSearch value={search} onSearch={setSearch} placeholder='Search completed services...' />
          </div>
