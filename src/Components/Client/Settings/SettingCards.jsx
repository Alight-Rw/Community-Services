...
import ConfirmDelete from "../../Provider/Dashboard/ConfirmDelete";
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 border">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Password and security settings</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 border">
          <div className="flex items-center gap-3 mb-4 mr-[300px]">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Email and notification preferences</p>
            </div>
          </div>
