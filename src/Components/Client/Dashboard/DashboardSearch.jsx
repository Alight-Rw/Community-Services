    ...
    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between w-full bg-white px-6 lg:px-10 py-4 gap-4">
      ...
      <div className="relative w-full lg:w-1/2">
        ...
        <input
          ...
          className={`${inputBaseStyles} pl-10 pr-4`}
        />
      </div>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <div className="relative flex items-center w-full md:w-44">
            <input
              ...
              className={`${inputBaseStyles} px-3 pr-10`}
            />
            <input
              type="date"
              ref={startRef}
              ...
              onChange={(e) => {
                const formatted = formatFromPicker(e.target.value);
            ...
            <Calendar
              size={18}
              className="absolute right-3 text-black cursor-pointer hover:text-gray-600 transition-colors"
