  ...
  return (
    <div className='dashboard-shell flex flex-col h-screen bg-small-soft-gray overflow-hidden'>
      <DashboardNav
        ...
        notifications={[
          { id: 1, type: "success", title: "Booking Creacted", message: "Two clients booked services at", time: "10:00 AM", minutes: "1m ago", isUnread: true },
      ...
      <div className='flex flex-1 overflow-hidden relative'>
        ...
        <main className='flex-1 pl-20 overflow-y-auto transition-all duration-300'>
          <div className='px-8 md:px-0 pt-20 md:space-y-1 '>
            <Paragraphy highlight={'Requested Services'} description={'Quick summary of services that have been requested by the client'} />
          </div>

          <div className='px-8 md:px-0 md:pr-12 py-10 w-[350px] md:w-full'>
            <DashboardSearch value={search} onSearch={setSearch} placeholder='Search completed requests...' />
          </div>
