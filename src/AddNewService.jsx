      ...
      <div className=" w-250  bg-white p-5 sm:p-10 rounded-2xl shadow-2xl border border-blue-100 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 py-2 md:px-6 gap-2">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input 
              className="border border-gray-300 rounded-lg w-full sm:w-100 h-[32px] md:h-[25px] px-3 focus:border-blue-500 text-sm "
              type="text" 
          ...
          <div className="sm flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-y-0 right-3 sm:right-[calc(100%-90px)] flex items-center pointer-events-none">
        ...
        <div className="sm-6 flex flex-col gap-1">
          ...
          <textarea 
            className="border border-gray-300 rounded-lg w-full md:w-full h-[80px] md:h-[60px] px-3 py-2 focus:border-blue-500 outline-none text-sm resize-none"
            placeholder="eg,. This service come to help community to get the service easily..."
          ></textarea>
        </div>
        <div className="sm-6 text-center">
          <label className="font-bold text-gray-800 text-sm block mb-2">Service Image<span className="text-red-600">*</span></label>
        ...
        <div className="sm-10 flex flex-col-reverse md:flex-row items-center justify-center gap-4">
          ...
          <button className="w-full sm:w-56 h-[45px] bg-[#0066FF] text-white font-bold rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all active:scale-95">
            Create Service
          </button>
        </div>
